 ...
 */
({
    deleteContactMedicalSchool : function(component, event, helper) {

        var action = component.get("c.deleteContactMedicalSchool");
        var id = component.get("v.school").Id;
        action.setParams( {
            "id": id
        });
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                //component.getEvent("schoolDeletedEvent").fire();
                $A.get("e.c:ApplicantMedicalSchoolDeletedAE").fire();
            } else {
