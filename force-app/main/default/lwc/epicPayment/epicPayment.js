...
import payCompletionForExtract from '@salesforce/apex/EpicCredVerController.statusChangeEpicExtract';
export default class EpicPayment extends LightningElement{
    @track spinner = false;
    @api caseRecordId;
    renderedCallback(){
